  ...
  // ── Auth (로그인/회원가입) ──────────────────
  {
    ...
    children: [
      ...
      },
      {
        path: 'password-new',
        name: 'PasswordNew',
        component: () => import('@/pages/auth/PasswordNewPage.vue'),
      },
    ],
  },
    ...
    children: [
      {
        ...
        component: () => import('@/pages/dashboard/FreelancerDashboardPage.vue'),
      },
      {
        path: 'account',
        name: 'AccountProfile',
      ...
      },
      {
        ...
        component: () => import('@/pages/recruitments/RecruitmentListPage.vue'),
      },
      {
        path: 'recruitments/:recruitmentId/apply',
        name: 'RecruitmentApply',
        component: () => import('@/pages/recruitments/RecruitmentApplyPage.vue'),
      ...
      },
      {
        path: 'portfolio',
        name: 'PortfolioList',
        component: () => import('@/pages/portfolio/PortfolioListPage.vue'),
      },
      {
        path: 'portfolio/new',
      ...
      },
      {
        ...
        component: () => import('@/pages/portfolio/PortfolioDetailPage.vue'),
      },
      {
      ...
      },
      {
        path: 'proposals',
        name: 'ProposalList',
        component: () => import('@/pages/proposal/ProposalListPage.vue'),
      },
    ],
  },
    ...
    children: [
      {
        ...
        component: () => import('@/pages/dashboard/CompanyDashboardPage.vue'),
      },
      {
        path: 'account',
        name: 'CompanyProfile',
        component: () => import('@/pages/account/CompanyProfilePage.vue'),
      },
      {
        path: 'calendar',
      ...
      },
      {
        ...
        component: () => import('@/pages/company/recruitments/CompanyRecruitmentListPage.vue'),
      },
      {
        path: 'recruitments/new',
        name: 'CompanyRecruitmentCreate',
        component: () => import('@/pages/company/recruitments/CompanyRecruitmentEditorPage.vue'),
      },
      {
        path: 'recruitments/:recruitmentId',
        name: 'CompanyRecruitmentDetail',
        component: () => import('@/pages/company/recruitments/CompanyRecruitmentDetailPage.vue'),
      },
      {
        path: 'recruitments/:recruitmentId/edit',
        name: 'CompanyRecruitmentEdit',
        component: () => import('@/pages/company/recruitments/CompanyRecruitmentEditorPage.vue'),
      },
      {
        path: 'recruitments/:recruitmentId/applicants/:applicationId',
        name: 'CompanyApplicantDetail',
        component: () => import('@/pages/company/applicants/CompanyApplicantDetailPage.vue'),
      },
      {
        path: 'applicants/:recruitmentId/:applicationId',
        redirect: (to) => ({
          name: 'CompanyApplicantDetail',
          params: {
            recruitmentId: to.params.recruitmentId,
      ...
      },
      {
        path: 'talents',
        name: 'TalentSearch',
        component: () => import('@/pages/company/talents/TalentSearchPage.vue'),
      },
      {
        path: 'talents/:id',
        name: 'TalentDetail',
        component: () => import('@/pages/company/talents/TalentDetailPage.vue'),
      },
      {
        path: 'bookmarks',
        name: 'TalentBookmark',
        component: () => import('@/pages/company/bookmarks/TalentBookmarkPage.vue'),
      },
      {
        path: 'notifications',
      ...
      {
        path: 'proposal/select',
        name: 'ProposalSelect',
        component: () => import('@/pages/proposal/ProposalSelectPage.vue'),
      },
